...
go down to line 723 and change the Ascii distro unless you want to keep the small Arcolinux logo there is lots of comments that you can follow and I would recommend customising the config
...
go down to line 723 and change the Ascii distro unless you want to keep the Arcolinux logo there is lots of comments that you can follow and I would recommend customising the config
